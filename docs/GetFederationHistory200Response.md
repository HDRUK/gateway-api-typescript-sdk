...
**data** | [**Array&lt;GetFederationHistory200ResponseDataInner&gt;**](GetFederationHistory200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { GetFederationHistory200Response } from '@hdruk/gateway-api-sdk';

const instance: GetFederationHistory200Response = {
    current_page,
    data,
    first_page_url,
    from,
