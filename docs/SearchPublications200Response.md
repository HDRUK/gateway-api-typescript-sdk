...
**data** | [**Array&lt;SearchPublications200ResponseDataInner&gt;**](SearchPublications200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { SearchPublications200Response } from '@hdruk/gateway-api-sdk';

const instance: SearchPublications200Response = {
    current_page,
    data,
    first_page_url,
    from,
