...
**data** | [**Array&lt;SearchDatasets200ResponseDataInner&gt;**](SearchDatasets200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { SearchDatasets200Response } from '@hdruk/gateway-api-sdk';

const instance: SearchDatasets200Response = {
    current_page,
    data,
    first_page_url,
    from,
