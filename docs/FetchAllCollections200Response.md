...
**data** | [**Array&lt;Collection&gt;**](Collection.md) |  | [optional] [default to undefined]
...
```typescript
import { FetchAllCollections200Response } from '@hdruk/gateway-api-sdk';

const instance: FetchAllCollections200Response = {
    message,
    data,
    first_page_url,
    from,
