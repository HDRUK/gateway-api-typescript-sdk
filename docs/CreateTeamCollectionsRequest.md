...
**tools** | [**Array&lt;CreateTeamCollectionsRequestDatasetsInner&gt;**](CreateTeamCollectionsRequestDatasetsInner.md) |  | [optional] [default to undefined]
...
```typescript
import { CreateTeamCollectionsRequest } from '@hdruk/gateway-api-sdk';

const instance: CreateTeamCollectionsRequest = {
    name,
    description,
    image_link,
    enabled,
