...
|[**fetchTeamDarApplicationHeader**](#fetchteamdarapplicationheader) | **GET** /api/v1/teams/{teamId}/dar/applications/{id}/showHeader | TeamDataAccessApplicationController@showHeader|
...
> FetchTeamDarApplicationHeader200Response fetchTeamDarApplicationHeader()
...
const { status, data } = await apiInstance.fetchTeamDarApplicationHeader(
    teamId,
    id
);
```
