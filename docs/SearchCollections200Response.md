...
**data** | [**Array&lt;SearchCollections200ResponseDataInner&gt;**](SearchCollections200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { SearchCollections200Response } from '@hdruk/gateway-api-sdk';

const instance: SearchCollections200Response = {
    current_page,
    data,
    first_page_url,
    from,
