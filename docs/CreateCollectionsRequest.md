...
**tools** | [**Array&lt;CreateCollectionsIntegrationsRequestDatasetsInner&gt;**](CreateCollectionsIntegrationsRequestDatasetsInner.md) |  | [optional] [default to undefined]
...
```typescript
import { CreateCollectionsRequest } from '@hdruk/gateway-api-sdk';

const instance: CreateCollectionsRequest = {
    name,
    description,
    image_link,
    enabled,
