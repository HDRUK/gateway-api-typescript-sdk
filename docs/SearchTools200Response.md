...
**data** | [**Array&lt;SearchTools200ResponseDataInner&gt;**](SearchTools200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { SearchTools200Response } from '@hdruk/gateway-api-sdk';

const instance: SearchTools200Response = {
    current_page,
    data,
    first_page_url,
    from,
