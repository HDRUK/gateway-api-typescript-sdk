...
**data** | [**Array&lt;SearchDataCustodianNetworks200ResponseDataInner&gt;**](SearchDataCustodianNetworks200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { SearchDataCustodianNetworks200Response } from '@hdruk/gateway-api-sdk';

const instance: SearchDataCustodianNetworks200Response = {
    current_page,
    data,
    first_page_url,
    from,
