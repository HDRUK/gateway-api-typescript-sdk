...
**data** | [**Array&lt;Keyword&gt;**](Keyword.md) |  | [optional] [default to undefined]
...
```typescript
import { FetchAllKeywords200Response } from '@hdruk/gateway-api-sdk';

const instance: FetchAllKeywords200Response = {
    message,
    data,
    first_page_url,
    from,
