...
**data** | [**Array&lt;GetFederationTeamId200ResponseDataInner&gt;**](GetFederationTeamId200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { GetFederationTeamId200Response } from '@hdruk/gateway-api-sdk';

const instance: GetFederationTeamId200Response = {
    current_page,
    data,
    first_page_url,
    from,
