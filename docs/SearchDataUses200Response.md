...
**data** | [**Array&lt;SearchDataUses200ResponseDataInner&gt;**](SearchDataUses200ResponseDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { SearchDataUses200Response } from '@hdruk/gateway-api-sdk';

const instance: SearchDataUses200Response = {
    current_page,
    data,
    first_page_url,
    from,
